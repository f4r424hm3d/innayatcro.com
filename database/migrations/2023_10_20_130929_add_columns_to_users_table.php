...
return new class extends Migration
{
  ...
  public function up(): void
  {
    Schema::table('users', function (Blueprint $table) {
      ...
      $table->bigInteger('login_count')->nullable()->after('password');
      ...
      $table->dateTime('last_login')->nullable()->after('profile_picture');
      $table->integer('otp')->nullable()->after('last_login');
      $table->string('otp_expire_at', 40)->nullable()->after('otp');
    });
  }
