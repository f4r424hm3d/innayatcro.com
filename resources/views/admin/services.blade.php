              ...
              <form action="{{ $url }}/" class="needs-validation" method="post" enctype="multipart/form-data"
                ...
                <div class="row">
                  <div class="col-md-6 col-sm-12 mb-3">
                    <x-InputField type="text" label="Enter Service Name" name="service_name" id="service_name"
                      :ft="$ft" :sd="$sd"></x-InputField>
                  </div>
                  <div class="col-md-6 col-sm-12 mb-3">
                    <x-InputField type="text" label="Enter Service URL" name="service_slug" id="service_slug"
                      :ft="$ft" :sd="$sd"></x-InputField>
                  </div>
                ...
                <tbody>
                  ...
                  @foreach ($rows as $row)
                    <tr id="row{{ $row->id }}">
                      <td>{{ $i }}</td>
                      <td>
                        <a href="{{ url($row->service_slug) }}" target="_blank">{{ $row->service_name }}</a>
                      </td>
                      <td>
