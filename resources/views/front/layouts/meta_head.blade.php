...
<meta property="og:site_name" content="Innayat CRO" />
<meta property="og:image" content="{{ url('web/assets/img/slider/1.webp') }}" />
...
<meta name="twitter:image" content="{{ url('web/assets/img/slider/1.webp') }}" />
<!-- Css File -->
